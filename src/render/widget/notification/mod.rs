...
impl Notification {
	...
	pub fn render(&mut self, builder: &mut VertexBufferBuilder, y: usize) {
		...
		builder.draw_texture_region_z(pos + (2, 2), NOTIFICATION_Z, NOTIFICATION_UV + (6, 2), (self.width + 6, self.height() - 4), (12, 16));
		builder.draw_texture_z(pos + (2, 2), NOTIFICATION_Z, NOTIFICATION_UV + (2, 2), (4, 16));
		builder.draw_texture_z(pos + (6 + self.width + 2, 0), NOTIFICATION_Z, NOTIFICATION_UV + (18, 0), (2, 2));
		builder.draw_texture_z(pos + (6 + self.width + 2, self.height() - 2), NOTIFICATION_Z, NOTIFICATION_UV + (18, 18), (2, 2));
		builder.draw_texture_z(pos + (0, self.height() - 2), NOTIFICATION_Z, NOTIFICATION_UV + (0, 18), (2, 2));
		builder.draw_texture_z(pos + (0, 0), NOTIFICATION_Z, NOTIFICATION_UV, (2, 2));
		{
			let mut remaining_width = self.width + 6;
			while remaining_width > 0 {
				builder.draw_texture_z(pos + (6 + self.width + 2 - remaining_width, 0), NOTIFICATION_Z, NOTIFICATION_UV + (2, 0), (16.min(remaining_width), 2));
				builder.draw_texture_z(pos + (6 + self.width + 2 - remaining_width, self.height() - 2), NOTIFICATION_Z, NOTIFICATION_UV + (2, 18), (16.min(remaining_width), 2));
		...
		}
		{
			...
			while remaining_height > 0 {
				...
				builder.draw_texture_z(pos + (6 + self.width + 2, self.height() - 4 - remaining_height + 2), NOTIFICATION_Z, NOTIFICATION_UV + (18, 2), (2, 16.min(remaining_height)));
