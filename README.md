...
# Compiling
### For Windows
* You must have [Rust](https://rustup.rs) 1.100.0+ \[Nightly 2026-09-01\] (target: x86_64-pc-windows-msvc)
...
### For Wasm
* You must have [Rust](https://rustup.rs) 1.100.0+ \[Nightly 2026-09-01\]
